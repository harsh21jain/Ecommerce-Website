...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'm')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Action & Adventure</button>
  <button class="tablinks" onclick="openCity(event, 'l')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Horror</button>
  <button class="tablinks" onclick="openCity(event, 'w')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Study Books</button>
  <button class="tablinks" onclick="openCity(event, 'h')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Motivation</button><br>
  <button class="tablinks" style="background-color: #ccc; border-radius: 30px;"><b>Brands</b></button>
<?php

$pro = mysqli_query($conn, "select * from product where category='Books'");
...
<div id="all" class="tabcontent">
  <div class="harsh">
  <img src="https://image.shutterstock.com/image-vector/promo-banner-bookstore-bookshop-library-260nw-1976145590.jpg" width="1400" height="300" style="margin-left: 50px;">
</div>
<?php
...
$pro = mysqli_query($conn, "select * from product where sub_category='Action and Adventure'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Horror'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='study'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='motivation'");
...
<footer class="bg-black" style="margin-top: 2700px;">
