...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'm')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Mobile</button>
  <button class="tablinks" onclick="openCity(event, 'l')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Laptop</button>
  <button class="tablinks" onclick="openCity(event, 'w')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Watch</button>
  <button class="tablinks" onclick="openCity(event, 'h')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Headphone</button><br>
  <button class="tablinks" style="background-color: #ccc; border-radius: 30px;"><b>Brands</b></button>
  <button class="tablinks">Apple</button>
  <button class="tablinks">Samsung</button>
  <button class="tablinks">Realme</button>
  <button class="tablinks">Oppo</button>
  <button class="tablinks">Vivo</button>
  <button class="tablinks">OnePlus</button>

</div>
<center><h3 style="color: red; margin-bottom: 30px; font-family: algerian;"><b>Electronics Products</b></h3></center> 
...
$pro = mysqli_query($conn, "select * from product where category='Electronic'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='mobile'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Laptop'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Digital Watch'");
