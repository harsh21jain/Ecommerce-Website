...
<html>
<head>
	<title>Furniture Products Page</title>
<meta charset="utf-8">
...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'all')" id="defaultOpen"><b>Books Categories</b></button>
  <button class="tablinks" onclick="openCity(event, 'm')"><i class="fa fa-check-square-o" aria-hidden="true"></i>  sectionals Sofa's</button>
  <button class="tablinks" onclick="openCity(event, 'l')"><i class="fa fa-check-square-o" aria-hidden="true"></i> L-Shape Sofa's</button>
  <button class="tablinks" onclick="openCity(event, 'w')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Cofe Chaires</button>
  <button class="tablinks" onclick="openCity(event, 'h')"><i class="fa fa-check-square-o" aria-hidden="true"></i> Single Seater Sofa</button><br>
  <button class="tablinks" style="background-color: #ccc; border-radius: 30px;"><b>Brands</b></button>
<?php

$pro = mysqli_query($conn, "select * from product where category='Furniture'");
...
?>
  <button class="tablinks"><?php echo $key['company'] ?></button>
<?php } ?> 
</div>
<center><h3 style="color: red; margin-bottom: 30px; font-family: algerian;"><b>Books Category</b></h3></center> 
<div id="all" class="tabcontent">
  <div class="harsh">
  <img src="https://style.ashleyfurniture.com.au/assets/uploads/images/Homepage-Banner-Living.jpg" width="1400" height="300" style="margin-left: 50px;">
</div>
<?php
...
$pro = mysqli_query($conn, "select * from product where sub_category='Sectionals'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Sofas'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Chaises'");
...
$pro = mysqli_query($conn, "select * from product where sub_category='Accent Chairs'");
...
<footer class="bg-black" style="margin-top: 2200px;">
